...
Locks: Unless otherwise noted, access to a locked door is controlled by the Station AI. The players can knock, and a guard will speak to them through an intercom, but there's no way to pick the lock without the AI's assistance.
